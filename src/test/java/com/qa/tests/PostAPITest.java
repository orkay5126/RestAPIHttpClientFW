...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Users users = new Users("Eashan", "leader"); //expected users obejct
		
		//object to json file:
		mapper.writeValue(new File("C:\\Ramesh Data\\Selenium\\Project Upload\\RestAPIHttpClientFW\\src\\main\\java\\com\\qa\\data\\users.json"), users);
